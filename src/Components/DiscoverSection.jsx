        ...
        <div className="mt-28 w-full flex justify-center items-center px-6">
            <div className="w-full max-w-[1500px] flex flex-col justify-center items-center">
                <div className="flex justify-center items-center flex-col text-center space-y-3">
                    ...
                    <span className="max-w-[440px] text-black/60">Explore a curated selection of top properties, handpicked to offer you the finest in real estate.</span>
                </div>
                ...
                <div className="mt-10 w-full">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="flex flex-col">
                            ...
                            <span className="text-2xl font-semibold mt-4">$750,000</span>
                            <span className="text-lg mt-2">Golden Leaf Residence</span>
                            <span className="text-md text-black/60">3beds both 240ft</span>
                        </div>
                ...
                <button class="flex px-5 py-3 items-center border border-primary rounded-3xl gap-2 font-medium mt-14 border-black">Let's see other property
